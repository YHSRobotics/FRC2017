...
public class RobotMap {
	...
	private final static int LWheelsID = 0, RWheelsID = 1, HopperActuatorID = 2, BallCollectorID = 3, ShooterActuatorID = 4;
	...
	public static Talon BallCollector = new Talon(BallCollectorID), ShooterActuator = new Talon(ShooterActuatorID);
